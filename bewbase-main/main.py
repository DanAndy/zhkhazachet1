...
class Kvartira(QWidget):
    ...
    def search(self):
        ...
        self.update_twStaffs(f"select * from Квартиросъемщики where IDkv = {row[0]}")
...
class Dogovorbl(QWidget):
    ...
    def search(self):
        ...
        self.update_twStaffs(f"select * from Договоры where IDdog = {row[0]}")
...
class Platezhi(QWidget):
    ...
    def search(self):
        ...
        self.update_twStaffs(f"select * from Платежи where IDpay = {row[0]}")
...
class Sotrudniki(QWidget):
    ...
    def search(self):
        row = self.leID.text()
        self.update_twStaffs(f"select * from Сотрудники where IDsotr = {row[0]}")
...
class Scheta(QWidget):
    ...
    def search(self):
        ...
        self.update_twStaffs(f"select * from Счета where IDschet = {row[0]}")
...
class Tarif(QWidget):
    ...
    def search(self):
        ...
        self.update_twStaffs(f"select * from Тарифы where IDtarif = {row[0]}")
...
class Yslygi(QWidget):
    ...
    def search(self):
        row = self.leID.text()
        self.update_twStaffs(f"select * from Услуги where IDyslygi = {row[0]}")
